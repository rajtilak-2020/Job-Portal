...
exports.register = async(request, response) => {
    ...
    var existingUser = await user.findOne({ email : request.body.email, deleted_at: '', role_type : 'Employer' });
...
exports.viewProfile = async(request, response) => {
    ...
    try {
        ...
        var userData = await user.findOne({ _id: decoded.userData._id, role_type : 'Employer' });  
