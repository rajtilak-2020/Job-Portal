...
exports.create = async(request, response) => {
    ...
    saveData.slug = await generateUniqueSlug(jobModal, slug);
    ...
    try {
        const inserData = new jobModal(saveData);
...
exports.details = async(request, response) => {
    ...
    await jobModal.findById(request.body.id)
    .then((result) => {
        if(result){
            const output = {
                _status : true,
